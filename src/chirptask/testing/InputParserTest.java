...
public class InputParserTest {
	...
	public void test() {
		...
		action4.addAction(new Action("delete", new Task(0, ""), new Action("add", new Task(0, ""))));
		action4.addAction(new Action("delete", new Task(1, ""), new Action("add", new Task(1, ""))));
		action4.addAction(new Action("delete", new Task(2, ""), new Action("add", new Task(2, ""))));
		assertEquals(action4, parser4.getActions());
		
		InputParser parser3 = new InputParser("edit 0 def");
		GroupAction action3 = new GroupAction();
		action3.addAction(new Action("edit", new Task(0, "def"), new Action("edit", new Task(0, ""))));
		...
		action2.addAction(new Action("add", new Task(0, "abc"), new Action("delete", new Task(0, "abc"))));
