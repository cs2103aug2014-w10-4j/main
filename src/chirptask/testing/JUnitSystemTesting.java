...
//      assertEquals("", _mainGui._userInput);
    ...
    public void validCommands() {
        ...
        assertEquals(
                "Successfully Added new task #Junit @Testing from 10am to 10pm tomorrow.",
                _mainGui._status);
        ...
        assertEquals(
                "Successfully Added new task #Junit @Testing2 by 12pm today.",
                _mainGui._status);
        ...
        assertEquals("Successfully: Done #Junit @Testing2 by 12pm today",
                _mainGui._status);
        ...
        assertEquals(
                "Successfully Removed task #Junit @Testing from 10am to 10pm tomorrow.",
                _mainGui._status);
        assertNull(_mainGui._taskViewDateMap.get(DisplayView
                .convertDateToString(Calendar.getInstance())));
