...
public class DisplayView {
	...
	private static void processGUI(StatusType message, CommandType type,
		...
		if (message == StatusType.ERROR) {
			...
			_gui.setError(String.format(Messages.LOG_MESSAGE_SUCCESS_OR_FAILURE, Messages.LOG_MESSAGE_FAIL, type.toString()));
		} else {
			
			_gui.setStatus(String.format(Messages.LOG_MESSAGE_SUCCESS_OR_FAILURE, Messages.LOG_MESSAGE_SUCCESS, type.toString()));
		}
